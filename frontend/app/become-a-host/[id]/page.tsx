...
export default function HostWizardStepPage() {
  ...
  const handleCreateListing = async () => {
    try {
      ...
      const imagesToSave = uploadedImages && uploadedImages.length > 0 ? uploadedImages : defaultPhotos;
      ...
      const saved = await apiSaveHostDraft(
        {
          ...
          description: description || 'Enjoy your stay at this wonderful property with modern amenities.',
          highlights: selectedHighlights.join(','),
          price_per_night: basePrice,
          weekend_price_percent: weekendAdjustment,
          weekly_discount_percent: weeklyDiscount,
                  ...
                  {propertyTypes.map((pt) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex flex-col items-start justify-between p-4 rounded-2xl border transition-all text-left cursor-pointer min-h-[120px] w-full overflow-hidden ${isSelected
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between p-6 rounded-2xl border transition-all text-left cursor-pointer ${isSel
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`flex flex-col items-start justify-between p-5 rounded-2xl border transition-all cursor-pointer min-h-[105px] ${isSelected
                            ? 'border-black dark:border-white bg-gray-50 dark:bg-[#262626] ring-2 ring-black dark:ring-white shadow-xs'
                            : 'border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1A1A1A] hover:border-black dark:hover:border-white'
                          }`}
                      >
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`px-6 py-3.5 rounded-full border text-sm md:text-base font-bold flex items-center gap-3 transition-all duration-200 cursor-pointer active:scale-95 hover:scale-105 ${isSel
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`w-full p-4 rounded-xl border transition-all duration-200 cursor-pointer text-left active:scale-[0.99] ${isSel
              ...
              <div className="w-full max-w-xl text-center pt-2 md:pt-4">
                ...
                <div className="space-y-3 text-left mb-6">
                  ...
                  <div
                    ...
                    className={`w-full p-4 rounded-xl border flex items-center justify-between transition-all cursor-pointer ${selectedDiscounts.includes('NEW_LISTING')
                  ...
                  <div
                    className={`w-full p-4 rounded-xl border flex items-center justify-between transition-all ${selectedDiscounts.includes('WEEKLY')
                        ? 'border-black dark:border-white bg-gray-50/80 dark:bg-[#262626] ring-2 ring-black dark:ring-white shadow-xs'
                        : 'border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1A1A1A]'
                      }`}
                  >
                  ...
                  <div
                    className={`w-full p-4 rounded-xl border flex items-center justify-between transition-all ${selectedDiscounts.includes('MONTHLY')
                        ? 'border-black dark:border-white bg-gray-50/80 dark:bg-[#262626] ring-2 ring-black dark:ring-white shadow-xs'
                        : 'border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1A1A1A]'
                      }`}
                  >
                  ...
                  <div
                    ...
                    className={`w-full p-4 rounded-xl border flex items-center justify-between transition-all cursor-pointer ${selectedDiscounts.includes('LAST_MINUTE')
                        ? 'border-black dark:border-white bg-gray-50/80 dark:bg-[#262626] ring-2 ring-black dark:ring-white shadow-xs'
                        : 'border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1A1A1A]'
                      }`}
                  >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        ...
                        className={`py-3.5 rounded-xl font-bold text-sm border transition-all cursor-pointer ${isBusinessHost === true
                      ...
                      <button
                        ...
                        className={`py-3.5 rounded-xl font-bold text-sm border transition-all cursor-pointer ${isBusinessHost === false
                            ? 'border-black dark:border-white bg-black dark:bg-white text-white dark:text-black'
                            : 'border-gray-300 dark:border-gray-700 hover:border-black dark:hover:border-white bg-white dark:bg-[#1A1A1A] text-airbnb-black dark:text-white'
                          }`}
                      >
